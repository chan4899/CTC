...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--use_sa_G', action='store_true', help='specify whether to use self-attention in Generator')
        parser.add_argument('--use_sa_D', action='store_true', help='specify whether to use self-attention in Discriminator')
